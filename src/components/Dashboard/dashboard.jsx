  ...
  const readExcel = (file) => {
    const promise = new Promise((resolve, reject) => {
      ...
      fileReader.onload = (e) => {
        ...
        // Sno	MID	TID	MerchantName	CreationDate	FlatAmount	Percentage	CountTrxnMon	SumTrxnMon	SumCommMon	SpendFrom	SpendTo	GeneratedOn
        ...
        ws = XLSX.utils.sheet_add_aoa(ws, Headings);
    ...
    promise.then(async (fileDataList) => {
      if (fileDataList) {
        ...
        dataList.map((row, index) => {
          ...
          addMerchant(row.MID, data, index, size);
        });
        setIsLoading(false);
      }
    });
